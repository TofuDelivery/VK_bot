...
public class VKCore {
    ...
    private VkApiClient vk;// Интерфейс взаимодействия с VK API с помощью запросов
    private static int ts;// Идентификатор сообщения, с которого нужно начинать обрабатывать сообщения
    private GroupActor actor;// Группа
    ...
    public VKCore() throws ClientException, ApiException {
        ...
        try {
           ...
           // groupId = Integer.valueOf(prop.getProperty("groupId"));
            ...
            access_token = "f4cb8fefeb9aa2bcc5b1e279fff580b9b16b21b1be7f9c38c0347db2900ecf16ae96e6e11d48d3effecb6";
